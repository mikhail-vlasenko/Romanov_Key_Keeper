"""
Django settings for key_keeper project.
...
# STATICFILES_STORAGE = 'config.storage.ManifestStaticFilesStorage'
STATICFILES_DIRS = (
...
WSGI_APPLICATION = 'key_keeper.wsgi.application'
